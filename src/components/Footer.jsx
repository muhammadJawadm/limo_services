      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 mb-10">
          ...
          <div className="max-w-xs">
            <h3 className="font-bold text-gray-900 text-lg text-white mb-3">Lemo Services</h3>
            <p className="text-gray-500 text-sm leading-relaxed text-white">
          ...
          {/* Right — Info Links */}
          <div>
            <h3 className="font-bold text-gray-900 text-lg mb-3 text-white">Information</h3>
            <ul className="flex flex-wrap items-center gap-x-6 gap-y-2">
              {infoLinks.map((link) => (
                <li key={link}>
                  <a href="#" className="text-gray-500 text-sm hover:text-blue-600 text-white transition-colors">
                    {link}
                  </a>
                </li>
              ))}
